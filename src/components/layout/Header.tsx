  ...
  return (
    ...
    >
      <div className="px-4 sm:px-6 py-3 flex items-center justify-between">
        <div className={cn("flex-1", sidebarCollapsed ? "pl-16" : "pl-64")}>
          <div className="flex items-center">
            <div>
              <h1 className="text-xl font-semibold text-gas-neutral-900 dark:text-white">{title}</h1>
              {subtitle && <p className="text-sm text-gas-neutral-500">{subtitle}</p>}
            </div>
          </div>
        </div>
